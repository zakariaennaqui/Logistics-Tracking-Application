@echo off
REM ============================================================
REM  Script de déploiement Livrago → HuggingFace (theuone)
REM  Services: warehouse, notification, product
REM ============================================================

set HF_USER=theuone
set HF_TOKEN=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
...
set SERVICES=warehouse-service:livrago-warehouse notification-service:livrago-notification product-service:livrago-product
