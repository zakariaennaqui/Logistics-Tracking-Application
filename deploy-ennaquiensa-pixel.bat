@echo off
REM ============================================================
REM  Script de déploiement Livrago → HuggingFace (ennaquiensa-pixel)
REM  Services: user, order, delivery
REM ============================================================

set HF_USER=ennaquiensa-pixel
set HF_TOKEN=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
...
set SERVICES=user-service:livrago-user order-service:livrago-order delivery-service:livrago-delivery
